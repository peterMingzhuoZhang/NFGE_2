...
GenerateMipsPSO::GenerateMipsPSO()
{
    ...
    mRootSignature.SetRootSignatureDesc(
    ...
    mDefaultUAV = NFGE::Graphics::AllocateDescriptors(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 4);
    ...
    for (UINT i = 0; i < 4; ++i)
    {
        ...
        device->CreateUnorderedAccessView(
            ...
            mDefaultUAV.GetDescriptorHandle(i)
        );
    }
}